...
Description: WP Contact Form is a drop in form for users to contact you. It can be implemented on a page or a post. It currently works with WordPress 2.0 ONLY
Author: Ryan Duff
...
http://dev.wp-plugins.org/newticket?&component=wp-contact-form
