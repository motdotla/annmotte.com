...
Copyright (C) 2007  erigami@piepalace.ca
...
if ( function_exists("is_plugin_page") && is_plugin_page() ) {
    ...
    add_option('miniposts_title', 'Miniposts 0.6.5', 'The title to display at the top of the minipost widget.');
...
#        }
    ...
    function plugin_minipost2_sidebar() {
        ...
        ?>
  <fieldset id="minipost_dbx" class="dbx-box">
    <h3 class="dbx-handle">MiniPost</h3> 
    <div class="dbx-content">
            <?php
        echo '<label for="is_mini_post"><input type="checkbox" name="is_mini_post" id="is_mini_post" value="1" '. $check . '/> '. __('This is a mini post', 'MiniPosts') . '</label><input type="hidden" name="miniposts_nonce" value="' . miniposts_nonce() . '"></div></fieldset>';
    }
    ...
    add_action('dbx_post_sidebar', 'plugin_minipost2_sidebar');
    ...
    function widget_miniposts2_init() {
        ...
        if (function_exists("register_sidebar_widget")) {
            register_sidebar_widget('Miniposts', 'widget_miniposts2_display');
        }
    }
